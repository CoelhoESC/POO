...
class Retangulo:
    ...
    def __add__(self, other):  # recebe a mesma instancia e recebe outra instancia!
        novo_x = self.x + other.x
        novo_y = self.y + other.y
        return Retangulo(novo_x, novo_y)

    def __repr__(self):  # mostrando os valores do object
        return f" <class 'Retangulo({self.x, self.y})'>"

    def get_area(self):
        return self.x * self.y

    def __lt__(self, other):  # Comparando se é menor
        a1 = self.get_area()
        a2 = other.get_area()
    ...
    def __gt__(self, other):  # Comprando se é maior
        a1 = self.get_area()
        a2 = other.get_area()
...
r2 = Retangulo(10, 20)
r3 = r1 + r2
# print(r1 + r2)  # interprete não sabe como utilizar o operador de +! Pra isso este os metodos magicos composto por'__'
print(r3)
print(r3 < r1)
print(r1 == r2)
